...
public class LabSix {
	 ...
	 * 
	 * You are given n lines. In each line there are zero or more integers. You need to
	 * answer a few queries where you need to tell the number located in yth
	 * position of xth line.
	 * 
	 * Input Format 
	 * 
	 * The first line has an integer n. In each of the next n lines there will be an integer d
	 * denoting number of integers on that line and then there will be d
	 ...
	 * Output Format 
	 * 
	 * In each line, output the number located in yth position of xth
